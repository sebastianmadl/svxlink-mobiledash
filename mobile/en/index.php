...
// dirname(__DIR__)        = .../whatever/mobile
...
// ── DTMF/TG Shortcut Buttons from dashboard config.php ───────────────────────
$dtmfBtns = [];
...
if (!$dtmfBtns) $dtmfBtns = [
    ...
    ['l'=>'Disconnect EL','d'=>'##','c'=>'red'],['l'=>'Disconnect TG','d'=>'*9#','c'=>'red'],
];
...
<header>
  <div class="h-inner">
    ...
    <div class="badge connected" id="badge">
      <span class="bdot" id="bdot"></span><span id="btext">CONNECTED</span>
    </div>
  </div>
</header>
...
<section class="page active" id="p-dashboard">
  ...
  <div class="livebar">
    ...
    <div class="ls"></div>
    <div class="lc"><div class="ll">ACTIVE TG</div><div class="lv blue" id="ls-tg">—</div></div>
    <div class="ls"></div>
    <div class="lc"><div class="ll">TALKER</div><div class="lv grn" id="ls-talker">—</div></div>
  </div>

  <div class="card">
    <div class="ch"><div class="ct"><span class="d grn"></span>SVXReflector Activity</div><span class="ltag" id="live-acts" style="display:none;">● <span id="liveTag" class="live-tag" style="display:none;">LIVE</span></span></div>
    <div id="alist" class="alist"><div class="empty">Waiting for data…</div></div>
  </div>
  ...
  <div class="card">
    ...
    <div class="rows">
      ...
      <div class="row"><span class="rl">Callsign</span><span class="rv blue"><?=htmlspecialchars($callsign)?></span></div>
      <div class="row"><span class="rl">Connection</span><span class="rv ok" id="rconn">● Connected</span></div>
  ...
  <a class="backlink" href="../../index.php">↗ Open Full Dashboard</a>
...
<section class="page" id="p-activity">
  <div class="card">
    <div class="ch"><div class="ct"><span class="d grn"></span>Recent Talkers</div><span class="ltag">● LIVE</span></div>
    <div id="alist2" class="alist"><div class="empty">Waiting for data…</div></div>
  </div>
  <p class="note" id="lu-note">Real-time via Server-Sent Events</p>
</section>
...
<section class="page" id="p-tg">
  ...
  <div class="card">
    <div class="ch"><div class="ct">Activate Manually</div></div>
    <div class="tgman">
      <input id="tgi" class="txti" type="number" inputmode="numeric" placeholder="TG number…">
      <button class="btn blue" onclick="activateTGMan()">Activate</button>
    </div>
  </div>
  <div class="card">
    <div class="ch"><div class="ct">Quick Actions</div></div>
    <div class="arow">
      <button class="btn red" onclick="sendDTMF('*9#')">Disconnect TG</button>
      <button class="btn red" onclick="sendDTMF('##')">Disconnect EL</button>
    </div>
  </div>
</section>
...
<section class="page" id="p-dtmf">
  <div class="card">
    <div class="ch"><div class="ct">DTMF Keypad</div></div>
    ...
    <div class="dact">
      <button class="btn gray" onclick="kc()">⌫ Clear</button>
      <button class="btn blue" onclick="ks()">Send</button>
    </div>
  </div>
  <div class="card">
    <div class="ch"><div class="ct">Quick Commands</div></div>
    <div class="qgrid">
...
<nav>
  ...
  <button class="nb" data-p="activity" onclick="go('activity',this)"><span>📶</span><span>Activity</span></button>
...
<!-- en/app.js: English strings + ../api/ paths for mobile/en/ location -->
